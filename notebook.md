...
[Is A 1000-Day Streak on Duolingo Worth It?](https://polyglotkent.com/blog/is-a-1000-day-streak-on-duolingo-worth-it)
...
**Prospective memory and the habit threshold, and why low-frequency tasks behave like one-off events**

- Why do we not need to remember to go to work 5 days a week, but we forget to do things that need to be done at the same time every week? 
...
**Intrinsic vs extrinsic rewards - external reward systems and how they compare to internal ones.**
...
Things that can be counted tend to be more socially legible than things that cannot. 

We have a tendency to overvalue what is measurable, and undervalue that which cannot be measured. 
